        ...
        <div className="relative z-10 grid md:grid-cols-2 gap-12">
          ...
          <div>
            <div className="flex items-center gap-3 mb-6">
              ...
              <h3 className="text-2xl font-orbitron text-white">Select Date</h3>
            </div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 max-h-[400px] overflow-y-auto pr-2 custom-scrollbar">
              {dates.map((date) => (
                ...
                >
                  ...
                  <div className="text-xl font-orbitron">{format(date, 'd')}</div>
          ...
          {/* Time Selection */}
          <div className="border-l border-white/10 md:pl-12 pt-8 md:pt-0">
            <div className="flex items-center gap-3 mb-6">
              <Clock className="text-neon-purple" />
              <h3 className="text-2xl font-orbitron text-white">Select Time</h3>
            </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              {TIME_SLOTS.map((time) => (
                <button
                  ...
                  className={`py-3 px-4 rounded-lg text-sm font-mono border transition-all duration-200 ${
                    selectedTime === time
            ...
            <div className="mt-8 pt-6 border-t border-white/10">
                ...
                <button
                    ...
                    className="w-full py-4 bg-gradient-to-r from-neon-blue to-neon-purple text-white font-bold tracking-widest rounded-xl disabled:opacity-30 disabled:cursor-not-allowed hover:opacity-90 transition-opacity shadow-[0_0_20px_rgba(0,243,255,0.3)]"
                >
                    CONFIRM SLOT
                </button>
            </div>
